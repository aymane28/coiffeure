 ...
 */
final class Version20230423135800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etablissement_calendar (etablissement_id INT NOT NULL, calendar_id INT NOT NULL, INDEX IDX_6CC02353A40A2C8 (calendar_id), INDEX IDX_6CC02353FF631228 (etablissement_id), PRIMARY KEY(etablissement_id, calendar_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MySQL57Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MySQL57Platform'."
        );
