...
final class Version20220918165400 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salon_calendar ADD CONSTRAINT FK_13EA6BBE4C91BDE4 FOREIGN KEY (salon_id) REFERENCES etablissement (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE salon_service ADD CONSTRAINT FK_A5C9D35D4C91BDE4 FOREIGN KEY (salon_id) REFERENCES etablissement (id) ON UPDATE NO ACTION ON DELETE CASCADE');
