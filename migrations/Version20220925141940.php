...
final class Version20220925141940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etablissement ADD service_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE etablissement ADD CONSTRAINT FK_20FD592CED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
        $this->addSql('CREATE INDEX IDX_20FD592CED5CA9E6 ON etablissement (service_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etablissement_service ADD CONSTRAINT FK_E58C8511FF631228 FOREIGN KEY (etablissement_id) REFERENCES etablissement (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE etablissement DROP FOREIGN KEY FK_20FD592CED5CA9E6');
        $this->addSql('DROP INDEX IDX_20FD592CED5CA9E6 ON etablissement');
        $this->addSql('ALTER TABLE etablissement DROP service_id');
    }
}
